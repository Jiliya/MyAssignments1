...
http.createServer(function(req,res){
    ...
    if(req.method=="GET") {
       res.end(` <!DOCTYPE html>
        ...
        <body>
            ...
            <table align="center"><tr><td>
             ...
             <tr><td>
               ...
               <td> <input type="text" id="ename" name="ename"/></td></tr>
                <tr><td><label>BasicPay</label></td>
                <td><input type="text" id="basic" name="basic"/></td>
                <tr><td colspan="2">    
                <button>calculate netpay</button></td></tr>
                <tr> <td><label>NetPay</label></td>
                <td><input type="netpay" id="ename" name="netpay"/></td></tr>
                </table>
            </form>
        </body>
        </html>
        ...
        <tr><td>   <label>BasicPay</label></td>
               <td> <input type="text" id="basic" name="basic" value="${basic}"/></td>
               </tr>
               <tr><td> <label>NetPay</label></td>
               <td><input type="netpay" id="ename" name="netpay" value="${netpay}"/></td>
                </tr>
                <tr>
        ...
        MongoClient.connect('mongodb://127.0.0.1:27017/nodexam',function(err,db){
            if(err){
                ...
                console.log(err);
                 ...
                 db.collection('nodxam').insert({"eId":eid,"eName":ename,
